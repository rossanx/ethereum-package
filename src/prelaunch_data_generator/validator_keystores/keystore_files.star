...
def new_keystore_files(
    ...
    cerver_keys_relative_dirpath,
    cerver_secrets_relative_dirpath,
):
    return struct(
        ...
        cerver_keys_relative_dirpath=teku_keys_relative_dirpath,
        cerver_secrets_relative_dirpath=teku_secrets_relative_dirpath,
    )
